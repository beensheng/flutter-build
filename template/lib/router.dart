...
import 'package:{{ PRO_NAME }}/pages/common/web_view_page.dart';
import 'package:{{ PRO_NAME }}/pages/home_page/index.dart';
import 'package:{{ PRO_NAME }}/widgets/common/error.dart';
import 'package:{{ PRO_NAME }}/util/struct/router.dart';

/// app 协议头
const String appScheme = "{{ PRO_NAME }}";
